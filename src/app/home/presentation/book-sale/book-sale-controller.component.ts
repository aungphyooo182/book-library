...
import { BookSaleStore } from "./book-sale.store";

@Component({
  selector: "app-book-sale",
  templateUrl: "./book-sale-controller.component.html",
  styleUrls: ["./book-sale-controller.component.css"],
})
export class BookSaleControllerComponent {
  constructor(
    @Inject(BusinessRequirementsInjectionToken)
    private business: BusinessLogicRequirements,
    private store: BookSaleStore,
